...
import chris.mod.beskarmod.items.armor.BeskarPinMissile;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> BESKAR_SWORD = ITEMS.register("beskar_sword", () -> new SwordItem(BeskarTier.BESKAR_TIER, 5,-5.4F,new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> BESKAR_SHOVEL = ITEMS.register("beskar_shovel", () -> new ShovelItem(BeskarTier.BESKAR_TIER, 6F,-3.0F,new Item.Properties().fireResistant()));
    ...
    public static final RegistryObject<Item> BESKAR_PICKAXE = ITEMS.register("beskar_pickaxe", () -> new PickaxeItem(BeskarTier.BESKAR_TIER, 2,-4.0F,new Item.Properties().fireResistant()));
    //--------------------------------------//
    //-------------------------ARMOR---------------------//
...
//------------------OTHER-------------------------//
    ...
    public static final RegistryObject<Item> BESKAR_PIN_MISSILE = ITEMS.register("pin_missile",() -> new BeskarPinMissile(new Item.Properties()));
}